        ...
        with open(username, 'a+') as file:
            for i in range(0, int(HEIGHT / SIZE)):
                for j in range(0, int(WIDTH / SIZE)):
                    self.maze[i][j].matrix_pos_x = i
                    self.maze[i][j].matrix_pos_y = j
                    if self.maze[i][j].color == BEIGE and not self.maze[i][j].energy_point:
                        file.write('0 ')
                    elif self.maze[i][j].color == BEIGE and self.maze[i][j].energy_point:
                        file.write('1 ')
            ...
            for line in file:
                if find:
                    ...
                    if int(size[0]) == 0:
                        ...
                        self.maze[i][j].color = BEIGE
                        self.maze[i][j].energy_point = True
                    elif int(size[0]) == 2:
